...
class Handle_Exc_Element_Decorator(object):
    ...
    def __init__(
        ...
        Args:
            ...
            index (optional): extract all elements of the list of individual lines of text starting from the ith element. Defaults to 0.
        """
    ...
    def __call__(self, func):
        ...
        def inner_function(*args, **kwargs):
            ...
            try:
                ...
                logging.error(
                    f"Element not present after {decorator_self.timeout} seconds on page: {decorator_self.browser.current_url}"
                )
                logging.exception(e.msg)
