...
from .locators import Checkout2PageLocators
...
class CheckoutPage_2(BasePage):
    ...
    def should_be_checkout_2_page(self):
        ...
        self.should_be_page_title("CHECKOUT: OVERVIEW", *Checkout2PageLocators.TITLE)
    ...
    def should_be_btn_to_checkout_complete_page(self):
        assert self.element_is_visible(Checkout2PageLocators.FINISH_BTN)

    # Переходит на страницу завершения оформления заказа
    def go_to_checkout_complete_page(self):
        self.click_button(*Checkout2PageLocators.FINISH_BTN)
