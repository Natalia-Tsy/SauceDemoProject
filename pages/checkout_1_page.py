...
class CheckoutPage_1(BasePage):
    ...
    def should_be_checkout_1_page(self):
        ...
        self.should_be_page_title("CHECKOUT: YOUR INFORMATION", *Chckout1PageLocators.TITLE)
    ...
    def set_shipping_info(self, firstname, lastname, code):
        ...
        self.browser.find_element(*Chckout1PageLocators.INPUT_FIRSTNAME).send_keys(firstname)
        # Пароль передается текстовому элементу на странице
        self.browser.find_element(*Chckout1PageLocators.INPUT_LASTNAME).send_keys(lastname)
